        ...
        <div className="flex flex-col lg:flex-row gap-12 relative">
          ...
          <aside className="w-full lg:w-[340px] shrink-0">
            <div className="lg:sticky lg:top-24">
              <div className="bg-[#0f2537] border border-white/5 rounded-[40px] overflow-hidden shadow-2xl group transition-all duration-500 hover:shadow-primary/10">
                <div className="p-10 text-center space-y-6">
                  <div className="relative inline-block">
                    <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-white/5 group-hover:border-primary/40 transition-all duration-700 mx-auto relative z-10">
                      <div className="w-full h-full bg-[#1a3a54] flex items-center justify-center">
                        <User className="w-20 h-20 text-white/20" />
                      </div>
                    </div>
                    <div className="absolute bottom-4 right-4 w-5 h-5 bg-[#AFB42B] rounded-full border-4 border-[#0f2537] z-20 shadow-lg animate-pulse"></div>
                  </div>
                  
                  <div className="space-y-2">
                    <h1 className="text-2xl font-black tracking-tight text-white">杨伟 - 前端开发</h1>
                    <p className="text-[11px] uppercase tracking-[0.3em] text-white/50 font-bold">A Front-end Engineer</p>
                  </div>
                  ...
                  <div className="flex justify-center gap-5">
                    {[MessageCircle, Mail, Phone, Github].map((Icon, i) => (
                      <button key={i} className="p-3 text-primary bg-white/5 hover:text-[#0f2537] hover:bg-primary rounded-2xl transition-all duration-500 hover:scale-110">
                  ...
                  <div className="space-y-5 text-sm px-4">
                    {[
                      ...
                      <div key={i} className="flex justify-between items-center">
                        <span className="text-[10px] uppercase tracking-[0.2em] text-white/40 font-black">{info.label}:</span>
                        <span className="font-bold text-white/80 tracking-wide">{info.value}</span>
                      </div>
                    ))}
                  </div>

                  <div className="pt-8">
                    <Button className="w-full bg-[#AFB42B] hover:bg-[#AFB42B]/90 text-[#0f2537] rounded-2xl py-7 font-black uppercase tracking-[0.2em] text-[11px] shadow-xl group">
          ...
          {/* Main Content */}
          <main className="flex-1 space-y-24 lg:space-y-32">
            ...
            <section className="hero-section relative min-h-[60vh] flex flex-col justify-center space-y-12 animate-in fade-in duration-1000">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={i} className="bg-card/40 backdrop-blur-md border border-white/5 p-10 rounded-3xl text-center space-y-3 hover:bg-card/60 transition-all duration-500 group shadow-xl hover:-translate-y-2">
            ...
            <section className="space-y-10 opacity-0">
              ...
              <div className="relative group">
                <div className="bg-card/40 backdrop-blur-md p-10 lg:p-14 rounded-[40px] italic text-muted-foreground text-lg leading-[1.8] relative border border-white/5 shadow-2xl">
              ...
              <div className="pt-12 border-t border-dashed border-white/10">
                <div className="flex flex-wrap gap-4">
                  {otherSkills.map((skill, i) => (
                    <div key={i} className="flex items-center gap-3 px-6 py-3 bg-card/40 rounded-2xl border border-white/5 text-[11px] font-black uppercase tracking-[0.2em] hover:border-primary hover:text-primary transition-all duration-500">
              ...
              <div className="relative space-y-16">
                ...
                {history.map((item, i) => (
                  <div key={i} className="relative sm:pl-12 group">
                    <div className="absolute left-0 top-2 w-5 h-5 rounded-full border-4 border-[#0f2537] bg-white/10 z-10 hidden sm:block group-hover:bg-primary transition-all"></div>
                    <div className={cn(
                      "p-10 rounded-[35px] border shadow-2xl transition-all duration-500 hover:-translate-y-2",
                      i % 2 === 0 ? 'bg-card/50 border-white/5' : 'bg-card/20 border-transparent'
                    )}>
            ...
            <section className="space-y-16 opacity-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="group bg-[#0f2537]/40 backdrop-blur-md border border-white/5 p-12 rounded-[45px] space-y-8 hover:-translate-y-3 transition-all duration-700">
                  <div className="w-20 h-20 bg-primary/10 rounded-3xl flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-[#0f2537] transition-all">
                    <Smartphone className="w-10 h-10" />
                  </div>
                  <div className="space-y-4">
                    <h4 className="text-2xl font-black text-white/90">移动应用</h4>
                ...
                <div className="group bg-[#0f2537]/40 backdrop-blur-md border border-white/5 p-12 rounded-[45px] space-y-8 hover:-translate-y-3 transition-all duration-700">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-2xl font-black text-white/90">PC应用或网站</h4>
            ...
            <section className="space-y-16 opacity-0 pb-20">
              <div className="flex items-center gap-6">
              ...
              <div className="bg-[#0f2537]/40 backdrop-blur-md border border-white/5 p-10 lg:p-16 rounded-[50px] space-y-12 shadow-2xl">
                <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                      <Label className="text-[11px] uppercase tracking-[0.4em] font-black text-white/40">您的称呼</Label>
                      <Input placeholder="Name" className="bg-white/5 border-white/10 rounded-2xl py-8 px-6 text-white focus:border-primary/50" />
                    </div>
                    <div className="space-y-4">
                      <Label className="text-[11px] uppercase tracking-[0.4em] font-black text-white/40">您的联系方式</Label>
                      <Input placeholder="Email / Phone / WeChat" className="bg-white/5 border-white/10 rounded-2xl py-8 px-6 text-white focus:border-primary/50" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <Label className="text-[11px] uppercase tracking-[0.4em] font-black text-white/40">要发送的消息...</Label>
                    <Textarea placeholder="Message content..." className="min-h-[200px] bg-white/5 border-white/10 rounded-[30px] p-8 text-white focus:border-primary/50 resize-none" />
                  </div>
