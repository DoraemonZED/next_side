...
export const resumeData = {
  ...
  // 经历卡片统一字段：eyebrow（标题上方标识）、sideInfo（右侧信息 / 可选 badge）、
  // tags（标题下标签）、detail（正文标题与条目）、projects（项目区标识与条目）、
  // credential（可选凭证）。type 仅用于区分工作 / 教育的图标与主题色。
  history: [
    {
      title: "容联云",
      date: "2025.10 — 至今",
      ...
      sideInfo: { text: "Node.js / Java 全栈开发工程师", badge: null },
      tags: ["Node.js", "Spring Boot", "React", "TypeScript", "Redis", "Docker"],
      detail: { label: "负责内容 / KEY RESPONSIBILITIES", items: ["主导核心业务服务与开放接口的领域建模、接口规范和版本治理。", "设计管理端状态流与组件抽象方案，推动前后端联调、灰度验证和稳定发布。", "参与链路性能排查与可观测性建设，保障高频业务迭代的交付质量。"] },
      projects: { label: "参与项目 / SELECTED PROJECTS", items: [{ name: "企业通信云管理平台", summary: "统一租户、资源与运营配置，沉淀可复用的业务管理能力。" }, { name: "业务服务与接口建设", summary: "构建核心领域接口，完善鉴权、幂等、异常治理与调用规范。" }, { name: "管理端组件体系", summary: "抽象通用表单与数据视图组件，提升多模块研发效率与一致性。" }] },
    },
    {
      title: "中国电子科技十所（外协）",
      ...
      type: "work",
      eyebrow: "WORK EXPERIENCE",
      sideInfo: { text: "高级 Node.js 全栈开发工程师", badge: null },
      tags: ["NestJS", "gRPC", "RabbitMQ", "Redis", "WebSocket", "SSE", "Python"],
      detail: { label: "负责内容 / KEY RESPONSIBILITIES", items: ["负责算法训练、实时数据与可视化场景的服务拆分和端到端研发。", "以 gRPC、消息队列和 Redis 构建高可用模块，处理异步任务编排与流量削峰。", "设计大模型流式响应、断线恢复和高频数据渲染链路，优化交互实时性。"] },
      projects: { label: "参与项目 / SELECTED PROJECTS", items: [{ name: "算法训练与实时数据平台", summary: "连接训练任务、结果分发与实时监控，支持多模块协同运行。" }, { name: "大模型交互与可视化系统", summary: "实现 SSE 流式输出、增量渲染与异常恢复，提升交互稳定性。" }, { name: "分布式任务调度服务", summary: "通过消息队列解耦异步任务，支持可靠投递、消费幂等与状态追踪。" }] },
    },
    {
      title: "不知其鸣科技",
      ...
      type: "work",
      eyebrow: "WORK EXPERIENCE",
      sideInfo: { text: "Node.js 全栈开发负责人", badge: null },
      tags: ["Node.js", "Vue 3", "FFmpeg", "Docker", "Nginx", "MySQL"],
      detail: { label: "负责内容 / KEY RESPONSIBILITIES", items: ["负责海外内容平台和企业系统的技术方案、核心模块研发与上线交付。", "搭建鉴权、资源管理与媒体处理链路，统筹 PC / H5 多端体验与接口协作。", "推进容器化部署、日志定位和发布流程标准化，提升系统可维护性。"] },
      projects: { label: "参与项目 / SELECTED PROJECTS", items: [{ name: "海外 ACG 内容平台", summary: "覆盖内容发布、资源管理与多端消费场景，支撑持续内容运营。" }, { name: "视频转码与分发链路", summary: "基于 FFmpeg 处理媒体任务，完善状态追踪与异常重试机制。" }, { name: "企业业务管理系统", summary: "交付核心业务流程与权限模块，完成容器化部署和生产环境上线。" }] },
    },
    {
      title: "中国通行服务有限公司",
      ...
      type: "work",
      eyebrow: "WORK EXPERIENCE",
      sideInfo: { text: "前端开发工程师", badge: null },
      tags: ["Vue 2", "ECharts", "GIS", "RBAC", "JavaScript"],
      detail: { label: "负责内容 / KEY RESPONSIBILITIES", items: ["参与通信基础设施与智慧交通产品的前端架构、业务模块及数据可视化研发。", "构建动态路由与 RBAC 权限体系，解决复杂表单、流程编排和多角色协作问题。", "负责 GIS 场景与 ECharts 大屏性能优化，保障复杂数据的清晰呈现与稳定交互。"] },
      projects: { label: "参与项目 / SELECTED PROJECTS", items: [{ name: "通信基础设施共建共享平台", summary: "实现资源协同、权限控制与业务流程管理，支持多角色高效协作。" }, { name: "智慧交通管理平台", summary: "集成地图态势、事件处置与运营数据，提升交通运营可视化能力。" }, { name: "运营分析数据大屏", summary: "构建多维指标与实时图表展示，支持管理层快速决策与异常研判。" }] },
    },
    // 工作与教育经历共用一套字段；type 仅决定图标与主题色。
    {
      type: "education",
      title: "山东英才学院",
      date: "2017.09 — 2020.06",
      eyebrow: "SHANDONG YINGCAI UNIVERSITY",
      sideInfo: { text: "计算机网络技术", badge: "大专" },
      tags: ["计算机网络技术", "C 语言", "Python", "线性代数", "离散数学", "操作系统", "数据结构与算法", "SQL Server 数据库"],
      detail: { label: "专业能力 / LEARNING OUTCOME", items: ["掌握计算机网络基础架构与网络技术基础。", "具备使用 C / Python 进行基础算法开发的能力。", "熟悉数据库管理、SQL 查询与基础性能优化。"] },
      projects: { label: "在校实践 / ACADEMIC PROJECTS", items: [{ name: "ASP.NET 医药管理系统", summary: "实现药品库存动态管理" }, { name: "学生数据管理系统", summary: "完成学生信息录入与管理" }, { name: "Python 爬虫项目", summary: "采集千千音乐 TOP100 榜单数据" }] },
      credential: { label: "PROFESSIONAL CERTIFICATE", value: "计算机及外部设备装配调试员 · 中级" },
    },
  ],
